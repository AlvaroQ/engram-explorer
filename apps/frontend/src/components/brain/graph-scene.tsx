...
export function GraphScene(props: Props) {
  ...
  if (!props.brainModel) {
    const { nodes, edges, debug = false, colorBy = 'project', onNodeClick, onNodeHover, onUserCameraStart, selected, hovered, detailOpen, matchedIds, focusNodeId, focusInsetRight, animate = true, onReady } = props
