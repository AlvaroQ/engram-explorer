...
import type { EdgeFamily, GraphEdgeRelation } from '../../features/brain/model/types.ts'
...
export function computeEdgeOpacity(
  ...
  const [ambientMin, ambientMax, focusOpacity] =
    family === 'semantic'
      ...
      : [SYNAPSE_AMBIENT_TOPIC_ROAD_MIN, SYNAPSE_AMBIENT_TOPIC_ROAD_MAX, SYNAPSE_FOCUS_TOPIC_ROAD_OPACITY]
