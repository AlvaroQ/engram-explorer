...
export function buildHexPalette(
...
export function nodeColor(node: GraphNode, nodes: readonly GraphNode[], colorBy: ColorBy): string {
 ...
 */
export function buildLegendMap(nodes: readonly GraphNode[], colorBy: ColorBy): LegendEntry[] {
