...
/**
 * Navigation state surface consumed by the canvas scene and page-level wiring.
 *
 * Previously defined in features/brain/navigation/use-brain-navigation.ts
 * (deleted); moved here so components/brain/* can import it without a
